...
export default defineTool({
  description:
    "Search the live web through Exa. You have no built-in browsing and no knowledge of anything current, so call this for any question that depends on public information you cannot already answer from this conversation: news, prices, people, products, documentation, company research, or checking whether a page says what the user thinks. This is not the route to a role or an application: anything about the candidate's own openings, roles, or applying goes to `find_goforay_roles`, however the request is worded. Never tell the user you cannot search. Summarize the results in plain prose with the source links; never paste this object.",
