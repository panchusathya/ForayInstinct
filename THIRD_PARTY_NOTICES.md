...
The browser tool names and input contracts originally followed
[`kernel/kernel-mcp-server`](https://github.com/kernel/kernel-mcp-server),
licensed under the MIT License. Browser execution now uses Browserbase's
Browser API and persistent Browserbase Contexts.
